...
<head>
    ...
    <meta name="keywords" content="餃子,フェス,福岡,長浜,入場料無料,プライバシーポリシー,2030">
    <meta name="author" content="ふくおか餃子FES">
    <meta property="og:type" content="website">
    <meta property="og:url" content="">
    <meta property="og:site_name" content="ふくおか餃子FES">
    <meta property="og:title" content="プライバシーポリシー｜ふくおか餃子FES">
    <meta property="og:description" content="ふくおか餃子FES！2030年4月27日(日)～5月12日(日) 開催！当サイトでのプライバシーポリシーはこちら。">
...
<body>
    ...
    <main class="l-wrapper">
        ...
        <section class="l-pravacy">
            <h2 class="c-pravacy-title">第1条（個人情報）</h2>
        ...
        <section class="l-pravacy">
            <h2 class="c-pravacy-title">第2条（個人情報の収集方法）</h2>
        ...
        <section class="l-pravacy">
            <h2 class="c-pravacy-title">第3条（個人情報を収集・利用する目的）</h2>
        ...
        <section class="l-pravacy">
            <h2 class="c-pravacy-title">第4条（利用目的の変更）</h2>
            <ol>
        ...
        <section class="l-pravacy">
            <h2 class="c-pravacy-title">第5条（個人情報の第三者提供）</h2>

            <ol>
                <li>当社は，次に掲げる場合を除いて，あらかじめユーザーの同意を得ることなく，第三者に個人情報を提供することはありません。ただし，個人情報保護法その他の法令で認められる場合を除きます。
                    <ul class="c-pravacy-text-list-abc">
                        ...
                        <li>予め次の事項を告知あるいは公表し，かつ当社が個人情報保護委員会に届出をしたとき
                            <ul class="c-pravacy-text-list-123">
        ...
        <section class="l-pravacy">
            <h2 class="c-pravacy-title">第6条（個人情報の開示）</h2>
            ...
            <ol>
                <li>当社は，本人から個人情報の開示を求められたときは，本人に対し，遅滞なくこれを開示します。ただし，開示することにより次のいずれかに該当する場合は，その全部または一部を開示しないこともあり，開示しない決定をした場合には，その旨を遅滞なく通知します。なお，個人情報の開示に際しては，1件あたり1，000円の手数料を申し受けます。
                    <ol class="c-pravacy-text-list-abc">
        ...
        <section class="l-pravacy">
            <h2 class="c-pravacy-title">第7条（個人情報の訂正および削除）</h2>
            <ol>
        ...
        <section class="l-pravacy">
            <h2 class="c-pravacy-title">第8条（個人情報の利用停止等）</h2>
            <ol>
        ...
        <section class="l-pravacy">
            <h2 class="c-pravacy-title">第9条（プライバシーポリシーの変更）</h2>
            <ol>
        ...
        <section class="l-pravacy">
            <h2 class="c-pravacy-title">第10条（お問い合わせ窓口）</h2>
